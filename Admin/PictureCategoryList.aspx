<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PictureCategoryList.aspx.cs" Inherits="PictureCategoryList" %>

<%@ Register Src="~/UserControl/ucMessage.ascx" TagPrefix="uc1" TagName="ucMessage" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Danh sách Loại hình ảnh</title>
</asp:Content>
    ...
    <main>
        <div class="container-fluid">
            <ol class="breadcrumb mb-4" style="cursor: pointer;">
                ...
                <li class="breadcrumb-item active">
                    <a href="PictureMainCategoryList.html">Danh Mục Hình Ảnh (Cấp Cha)</a>
                </li>
                <li class="breadcrumb-item active">
                    <a href="PictureCategoryList.html">Danh Mục Hình Ảnh (Cấp Con)</a>
                </li>
            </ol>

            <h4 style="text-align: center; font-size: 30px; margin-top: 10px; color: #747506;">LOẠI HÌNH ẢNH
            </h4>
            <div class="row-fluid">
                ...
                <div class="span9">
                    <div class="card mb-4">
                        <div class="card-header" style="cursor: pointer;">
                            ...
                            <a href="PictureCategoryList.aspx" title="Thêm mới" style="float: right; margin: 0px 8px 7px 10px; font-size: 20px;">
                        ...
                        <div class="block-fluid  customize">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span7">
                                    <asp:DropDownList runat="server" ID="DropDownList_CategoryDetail" />
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="span7">
                                    <label class="checkbox inline">
                                        <input type="radio" runat="server" id="radio_StatusYes" name="status" checked />
                                        Cho phép hiển thị
                                    </label>
                                    <label class="checkbox inline">
