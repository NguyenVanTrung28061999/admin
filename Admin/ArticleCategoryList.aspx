<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ArticleCategoryList.aspx.cs" Inherits="ArticleCategoryList" %>

<%@ Register Src="~/UserControl/ucMessage.ascx" TagPrefix="uc1" TagName="ucMessage" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Danh sách loại tin tức - Admin</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <main>
        <div class="container-fluid">
            ...
            <h4 style="text-align: center; font-size: 30px; margin-top: 10px; color: #747506;">LOẠI TIN TỨC
            </h4>
            <div class="row-fluid">
                ...
                <div class="span9">
                    <div class="card mb-4">
                        <div class="card-header" style="cursor: pointer;">
                            ...
                            <a href="ArticleCategoryList.aspx" title="Thêm mới" style="float: right; margin: 0px 8px 7px 10px; font-size: 20px;">
