...
public partial class PictureMainCategoryList : System.Web.UI.Page
{
    ...
    public void LoadData()
    {
        ...
        var query = db.PictureMainCategories
        ...
        ListBox_List.DataValueField = "PictureMainCategoryID";
        ...
        item.Text = ".: Chọn loại Hình Ảnh cấp cha :.";
    ...
    public void LoadDetail()
    {
        ...
        //Load data
        input_ID.Value = item.PictureMainCategoryID.ToString();
    ...
    protected void ListBox_List_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("PictureMainCategoryList.aspx?id={0}".StringFormat(id));
    }
    ...
    protected void LinkButton_Delete_Click(object sender, EventArgs e)
    {
        ...
        if (item != null)
        {
            ...
            var childCoutQuery = db.PictureCategories.Where(x => x.PictureMainCategoryID == id).Count();
            if (childCoutQuery > 0)
            {
                ucMessage.ShowError("Không thể xóa dữ liệu do ràng buộc với các loại hình ảnh liên quan");
                return;
            }
