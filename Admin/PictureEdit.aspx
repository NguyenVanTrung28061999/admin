<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PictureEdit.aspx.cs" Inherits="PictureEdit" %>

<%@ Register Src="~/UserControl/ucMessage.ascx" TagPrefix="uc1" TagName="ucMessage" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Thêm/Chỉnh Sửa Hình Ảnh</title>
</asp:Content>
    ...
    <main>
        <div class="container-fluid">
            <ol class="breadcrumb mb-4" style="cursor: pointer; font-size: 13px;">
                ...
                <li class="breadcrumb-item active">
                    <a href="PictureEdit.html">Chỉnh Sửa & Thêm Mới Hình Ảnh</a>
                </li>

            </ol>

            <h4 style="text-align: center; font-size: 30px; margin-top: 10px; color: #747506;">THÊM / CHỈNH SỬA HÌNH ẢNH
            </h4>

            <div class="card mb-4">
                <div class="card-header" style="cursor: pointer;">
                    <i class="fas fa-list-ul mr-1"></i>
                    Đăng / Cập Nhật Hình Ảnh
                </div>
